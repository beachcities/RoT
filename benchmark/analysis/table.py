...
>
> **履歴には以前の版が残っている。落としたのは現在の版だけで、意図的にそうしている。**
> 落とした本文は合成データに対するモデルの応答であって、個人情報でも認証情報でもない。
> 現在の版から落とすのは公開方針に揃えるためであり、流出への対処ではない。
> 公開済みの履歴を書き換えるほうがリスクが大きいと判断した（2026-08-23）。"""
